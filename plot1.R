...
author: "Darwin Nava"
date: "April 11, 2021"
file: "Total_emission_pm25_by_year.R"
---
...
plot(total_emissions$year, total_emissions$Emissions, 
     ...
     main = "Total PM2.5 emission in USA. Years 1999, 2002, 2005, and 2008",
     col.axis = "blue", col.lab="red", ylim = c(3000000, 8000000),
     xlim= c(1999, 2010)
     )
mtext("Conclusion: The total decrease in pm2.5 emissions in the USA is observed.")
## generating png file and closing device
#dev.copy(png, file="total_emissions_pm25_USA.png", width=480, height=480)
